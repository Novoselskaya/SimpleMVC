...
<form id="editUser" method="post" action="<?= $Url::link("admin/adminusers/edit&id=" . $_GET['id'])?>">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="pass_part2" id="pass_part2" placeholder="пароль часть 2" value="">
    </div>
    <div class="form-group">
        <label for="pass_part3">Введите пароль (часть 3)</label>
        <input type="text" class="form-control" name="pass_part3" id="pass_part3" placeholder="пароль часть 3" value="">
    </div>
    <div class="form-group">   
